...
namespace BF2Statistics.Gamespy.Net
{
    ...
    public abstract class GamespyTcpSocket : IDisposable
    {
        ...
        public void Release(GamespyTcpStream Stream)
        {
            ...
            {
                // Log this error
                L.LogError("WARNING: [GamespyTcpSocket.Release] Event Args were disposed imporperly!");
        ...
        protected async void PrepareAccept(SocketAsyncEventArgs AcceptEventArg)
        {
            ...
            if (ConnectionEnforceMode == EnforceMode.DuringPrepare)
            {
                ...
                if (!Success)
                {
                    ...
                    L.LogError("NOTICE: [GamespyTcpSocket.PrepareAccept] The Server is currently full! Rejecting connecting client.");
            ...
            {
                // Report Error
                L.LogError("ERROR: An Error occured at [GamespyTcpSocket.PrepareAccept] : Generating Exception Log");
                ExceptionHandler.GenerateExceptionLog(e);
