            ...
            return new NewsItemDTO[]
            {
                new NewsItemDTO()
                {
                    ...
                    Russian = new NewsLanguageItemDTO
                    {
                        ...
                        Body =
                            ...
                            "SugarOasis (2), Deadly Fun Archeology (2), Vortex Plateau (2), Cold War(4)\n" +
                            "удалены карты: Edemus gamble(2), Tranquilitys End (2), Outer Reaches (2)\n\n Удачи в рейтинге!"
                    },
                    ...
                    English = new NewsLanguageItemDTO
                    {
                        ...
                        Body =
                            "<b>Dear Players!</b>\n\n Add new tab InGame, now you can see random player's races, mmr and loading status!\n Added three new maps in automatch: " +
                            "sugar_oasis(2), deadly_fun_archeology(2), Vortex Plateau (2), Cold War(4)\n" +
                ...
                new NewsItemDTO()
                {
                    ...
                    Russian = new NewsLanguageItemDTO()
                    {
                        ...
                        Annotation =
                            "Финал конкурса наступил и теперь судьям предстоит выбрать лучшие карты, которые имеют все шансы быть в автоподборе в ближайшем будущем!",
                        Body =
