...
namespace Steamworks {
	...
	public static class SteamAPI {
        ...
        public static void SetMiniDumpComment(string comment)
        {
            InteropHelp.TestIfPlatformSupported();
            using (var commentHandle = new InteropHelp.UTF8StringHandle(comment))
                NativeMethods.SteamAPI_SetMiniDumpComment(commentHandle);
        }
